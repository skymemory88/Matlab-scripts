...
O64s=-1i*0.25*((11*Jz^2-X*eye(16)-38*eye(16))*(Jp^4-Jm^4)+(Jp^4-Jm^4)*(11*Jz^2-X*eye(16)-38*eye(16)));
...
% B = [ 0.058125  -0.00053625   -0.0055255    -6.25e-09  -0.00010633  -2.3793e-05];       % Refinement around Kraemer's thesis parameters
% B = [ 0.058125  -0.00045   -0.0055255    -6.25e-09  -0.00010633  -2.3793e-05];       % Tune B40
