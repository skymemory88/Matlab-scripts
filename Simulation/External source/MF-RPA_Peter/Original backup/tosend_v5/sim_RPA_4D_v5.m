...
sample.A_Ho = 0.003361;     % hyperfine coupling energy in meV (from PRB 75 054426).
...
% Sample shape
sample.alpha=1; % shape is a sphere [1].
...
sample.h4 = 0;                              % introduce h4 anisotropy due to order by disorder, h4(Jx^4 + Jy^4)
%% Set input parameters defined in sample_in structure
% (sim_RPA_4D_v4 can be called by other functions)
