...
%      fprintf('ion %d h_dip %f %f %f \n',ionn, h_dipol_er(1), h_dipol_er(2), h_dipol_er(3))
     ...
     if xEr>0
         if ErHyp > 0
             ...
             I_Er=sample.I_Er;
             [jx,jy,jz,junk,Ham]=MF_moments_hyper(hvec,h_mf_er,t,J_Er,gLande_Er,cryst_Er,A_Er,I_Er,h4);
             momente_er_hyp(ionn,:)=update_moments([jx,jy,jz],evolution.er_hyp,ionn,iterations);
             sample.Ham_hyp_Er(ionn,:,:) = Ham;
         end
         if ErHyp~=1
             junk=[];
             [jx,jy,jz,junk,Ham]=MF_moments(hvec,h_mf_er,t,J_Er,gLande_Er,cryst_Er,h4);
     ...
     if xHo>0
         if HoHyp
           ...
           I_Ho=sample.I_Ho;
           [jx,jy,jz,junk,Ham]=MF_moments_hyper(hvec,h_mf_ho,t,J_Ho,gLande_Ho,cryst_Ho,A_Ho,I_Ho,h4);
           momente_ho(ionn,:)=update_moments([jx,jy,jz],evolution.ho,ionn,iterations);
           sample.Ham_hyp_Ho(ionn,:,:) = Ham;
         else
           junk=[];
           [jx,jy,jz,junk,Ham]=MF_moments(hvec,h_mf_ho,t,J_Ho,gLande_Ho,cryst_Ho,h4);
           momente_ho(ionn,:)=update_moments([jx,jy,jz],evolution.ho,ionn,iterations);
