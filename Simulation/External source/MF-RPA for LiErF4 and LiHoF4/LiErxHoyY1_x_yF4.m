function [JEr,altJEr,JErhyp,altJErhyp,JHo,altJHo,history,nbit]=LiErxHoyY1_x_yF4(x,y,temp,field,exEr,exHo,ErHyp,HoHyp,demagn,alpha,renorm_Er,renorm_Ho)
%Compute the magnetization and the alternated magnetization for a range of
%temperatures and
...
for i = 1:size(field,2)
    for j = 1:length(temp)
        [mom_Er,mom_Er_hyp,mom_Ho,evolution,nbiteration]=remf_2(field(:,i)',temp(j),mom_Er,mom_Ho,exHo,exEr,x,y,ErHyp,HoHyp,demagn,alpha,renorm_Er,renorm_Ho);
