...
Q=0; %<J> as a function of H (Q=1) or T (Q=0) ?
...
%% Save results
if Q == 1
    cd('C:\Users\ikovacev\Documents\Projects\LiHoF4_EPR_MF_calculations_and_literature\saved_mf_results\3.42GHz\fieldscan')
    save('fieldscan.mat','temp','fields','ion','history','E')
else
    cd('C:\Users\ikovacev\Documents\Projects\LiHoF4_EPR_MF_calculations_and_literature\saved_mf_results\3.42GHz\tempscan')
    save('tempscan.mat','temp','fields','ion','history','E')
end
