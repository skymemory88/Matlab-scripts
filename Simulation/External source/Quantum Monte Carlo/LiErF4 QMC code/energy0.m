function E_0=energy0(ion,params,inter,lattice,lat_mom)
...
for i=1:size(lattice,2)
    ...
    ion1.mom=gLande1*lat_mom(1:3,i)';
    ion1.energy=lat_mom(6,i);
    ...
    for j=1:size(lattice,2)
        ...
        ion2.mom=gLande2*lat_mom(1:3,j)';
%         ion2.energy=lat_mom(6,i); %Why is this 'i' not 'j'? --Yikai
        ion2.energy=lat_mom(6,j); % --Yikai
