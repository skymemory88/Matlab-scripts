function [init, meas, coef, ion, params] = LiReF4_CMC_Yikai(mion, dims, hyperfineOpt, loadOpt, plotOpt, saveOpt)
...
[eSpinT, nSpinT, coef, E_si, E_int, E_tot, dE, accpRate] = equilibrate(const, ion, params, hamI, coef, basis, E_si, E_int, E_tot, eSpin0, nSpin0);
...
while SampSz <= params.sampSize
    [Mx, My, Mz, coef, eSpinT, nSpinT, E_si, E_int] = MC_sample(const, ion, params, E_si, E_int, hamI, basis, coef, eSpinT, nSpinT); 
    if SampSz == 1
        meas.Mx = Mx;
        meas.My = My;
        meas.Mz = Mz;
