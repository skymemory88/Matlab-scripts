...
if  ~loadOpt
    [E_si, eSpin0, nSpin0, params] = initialize(const, ion, params, coef, basis, hamI);
end

% reach thermal equilibrium
[eSpinT, nSpinT, coef, E_si, dE, accpRate] = equilibrate(const, ion, params, hamI, coef, basis, E_si, eSpin0, nSpin0);
