function MCmeasuretempscan(filein_id,measN,meas_intv)
...
[relaxE,relaxE2,bestE,bestE2,acc_rate,C_v,malt,lat_mom,params,TT,meas] = paraTloop(ion,params,inter,lattice,EQlat_mom);
...
filename=sprintf(['results_tempscan_',params.jobid,'_%u_%u.mat'],params.Nitermeas, params.meas_intv);
% save(filename,'relaxE','bestE','bestE2','C_fdt','C_v','chi_v','chi','mmagsq','angl','msq0','msqx','msqy','mmag','malt','params','lat_mom','-v7.3');
save(filename,'relaxE','relaxE2','bestE','bestE2','acc_rate','C_v','C_fdt','malt','lat_mom','params','TT','meas','-v7.3');
