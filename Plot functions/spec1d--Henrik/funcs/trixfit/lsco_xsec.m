...
delta=[p(10) p(10)];
s_qw1=p(9)^2./(qh.^2+ql.^2-2*qh*delta(1)-2*ql*delta(2)+delta(1)^2+delta(2)^2+p(9)^2).^2;

delta=[-p(10) p(10)];
s_qw2=p(9)^2./(qh.^2+ql.^2-2*qh*delta(1)-2*ql*delta(2)+delta(1)^2+delta(2)^2+p(9)^2).^2;

delta=[p(10) -p(10)];
s_qw3=p(9)^2./(qh.^2+ql.^2-2*qh*delta(1)-2*ql*delta(2)+delta(1)^2+delta(2)^2+p(9)^2).^2;

delta=[-p(10) -p(10)];
s_qw4=p(9)^2./(qh.^2+ql.^2-2*qh*delta(1)-2*ql*delta(2)+delta(1)^2+delta(2)^2+p(9)^2).^2;
