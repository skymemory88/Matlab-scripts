addpath(genpath('C:\Users\yiyang\Google Drive\File sharing\Programming scripts\Matlab\Plot functions\spec1d--Henrik'));
format long g;
scan = importdata('C:\Users\yiyang\Google Drive\File sharing\PhD projects\LiHoF4 project\Data\Experiment\LiHoF4\SC127\22.10.2019\detune_300K_air.dat',',',3);
...
bw11 = freq11(ampdB_S11 <= -3);
f0 = freq11(Idx11);
Q11 = freq11(Idx11)/range(bw11); %Calculate the quality factor

clear j i;

% %Option 2: Calculate Quality factors from lorentzian fitting
...
legend(num2str(f0/1e9, 'Cavity (f_0 = %3.2f GHz)'),num2str(f0_2/1e9, 'Active (f_0 = %3.2f GHz)'));
