...
% plot(H0(1:15:end),dB0(1:15:end),'o-');
...
% % dB0 = medfilt1(dB0,order);
% dB0 = smoothdata(dB0,'loess');
% plot(H0(1:15:end),dB0(1:15:end),'s-');
...
% load('Up_0.250_-20dBm_0dB.mat');
% dB0 = dB0(H0 >= Hmin & H0 <= Hmax);
% H0 = H0(H0 >= Hmin & H0 <= Hmax);
% % dB0 = medfilt1(dB0,order);
% dB0 = smoothdata(dB0,'loess');
% plot(H0(1:15:end),dB0(1:15:end),'>-');
% lgd = [lgd, 'Up 250mK -20dBm 0dB'];
% dBmax = [dBmax; unique(H0(dB0 == max(dB0))), max(dB0), -20];
% dBmin = [dBmin; unique(H0(dB0 == min(dB0))), min(dB0), -20];
...
dB0 = smoothdata(dB0,'loess');
plot(H0(1:15:end),dB0(1:15:end),'o-');
% plot(H0(1:15:end),smoothdata(dB0(1:15:end)),'o-');
...
% % dB0 = medfilt1(dB0,order);
% dB0 = smoothdata(dB0,'loess');
% plot(H0(1:15:end),smoothdata(dB0(1:15:end)),'s-');
% lgd = [lgd, 'Down 250mK -10dBm 30dB'];
% dBmax = [dBmax; unique(H0(dB0 == max(dB0))), max(dB0), -10];
% dBmin = [dBmin; unique(H0(dB0 == min(dB0))), min(dB0), -10];

% load('Down_0.250_-10dBm_0dB.mat');
% dB0 = dB0(H0 >= Hmin & H0 <= Hmax);
% H0 = H0(H0 >= Hmin & H0 <= Hmax);
% dB0 = medfilt1(dB0,order);
% % dB0 = smoothdata(dB0,'loess');
% plot(H0(1:15:end),smoothdata(dB0(1:15:end)),'s-');
% lgd = [lgd, 'Down 250mK -10dBm 0dB'];
% dBmax = [dBmax; mean(unique(H0(dB0 == max(dB0)))), max(dB0), -10];
% dBmin = [dBmin; mean(unique(H0(dB0 == min(dB0)))), min(dB0), -10];
...
% dBmax = [dBmax; unique(H0(dB0 == max(dB0)),'last'), max(dB0), -10];
% dBmin = [dBmin; unique(H0(dB0 == min(dB0)),'last'), min(dB0), -10];
...
% % dB0 = medfilt1(dB0,order);
% dB0 = smoothdata(dB0,'loess');
% plot(H0(1:15:end),dB0(1:15:end),'d-');
...
% dB0 = smoothdata(dB0,'loess');
% plot(H0(1:15:end),dB0(1:15:end),'.-');
% % plot(H0(1:15:end),smoothdata(dB0(1:15:end)),'.-');
...
% % dB0 = medfilt1(dB0,order);
% dB0 = smoothdata(dB0,'loess');
% plot(H0(1:15:end),dB0(1:15:end),'x-');
...
% dB0 = dB0(H0 >= Hmin & H0 <= Hmax);
% H0 = H0(H0 >= Hmin & H0 <= Hmax);
% dB0 = medfilt1(dB0,5*order);
% % dB0 = smoothdata(dB0,'loess');
% plot(H0(1:15:end),dB0(1:15:end),'x-');
% % plot(H0(1:15:end),smoothdata(dB0(1:15:end)),'x-');
% lgd = [lgd, 'Down 400mK +10dBm 30dB'];
% dBmax = [dBmax; mean(unique(H0(dB0 == max(dB0)))), max(dB0), 10];
% dBmin = [dBmin; mean(unique(H0(dB0 == min(dB0)))), min(dB0), 10];
