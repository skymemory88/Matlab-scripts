...
switch platform
    case 'Win' %for Windows
        location = 'G:\My Drive\File sharing\PhD program\Research projects\LiHoF4 project\Data\Experiment\LiHoF4\SC239\';
        divd = '\';
...
if any([temp == 0.10, temp == 0.15], 'all')
...
elseif any([temp == 0.135, temp == 0.181], 'all')
...
elseif any([temp == 0.18, temp == 0.22], 'all')
...
elseif any([temp == 0.24, temp == 0.26], 'all')
...
elseif any([temp == 0.25, temp == 0.30], 'all')
