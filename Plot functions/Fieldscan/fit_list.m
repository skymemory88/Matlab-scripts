...
if ispc
    location = 'C:\Users\skyme\OneDrive - Nexus365\PhD\LiHoF4\Experiments\SC239\';
    divd = '\';
else
    location = ['/Users/yikaiyang/Library/CloudStorage/GoogleDrive-yikai.yang@epfl.ch/My Drive/',...
        'File sharing/PhD program/Research projects/LiHoF4 project/Data/Experiment/LiHoF4/SC239/'];
    divd = '/';
end

if any([temp == 0.10], 'all')
...
%     aux_files(5) = "2021_07_0004_0.167K_10.41-12.59T"; % alternative/additional fits
    aux_files(6) = "2021_07_0004_0.167K_12.41-14.49T";
...
%     aux_files(7) = "2021_07_0004_0.167K_12.50-15.99T"; % alternative/additional fits
    location = [location, '2021.07.05', divd];
    cmapfig = 'LiHoF4_3.52-3.76GHz_17-0T_180mK_-25dBm_0dB.fig';
elseif any([temp == 0.18], 'all')
...
%     aux_files(7) = "2021_07_0006_0.201K_13.01-15.99T"; % alternative/additional fits
    location = [location, '2021.07.07', divd];
    cmapfig = 'LiHoF4_3.52-3.76GHz_0-17T_220mK_-25dBm_0dB.fig';
elseif any([temp == 0.24], 'all')
...
%     aux_files(7) = "2021_07_0007_0.258K_12.17-14.70T"; % alternative/additional fits
    location = [location, '2021.07.08', divd];
    cmapfig = 'LiHoF4_3.52-3.76GHz_0-17T_260mK_-25dBm_0dB.fig';
elseif any([temp == 0.25], 'all')
    aux_files(1) = "2021_07_0008_0.291K_0.00-4.35T";
...
%     aux_files(2) = "2021_07_0008_0.291K_5.51-7.00T"; % alternative/additional fits
    ...
    location = [location, '2021.07.09', divd];
